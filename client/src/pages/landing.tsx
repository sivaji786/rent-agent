      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <span className="text-3xl font-bold text-gray-900">PropertyFlow</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600">Track rent collection, expenses, and generate financial reports with ease.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600">Provide tenants with a modern portal for payments, requests, and communication.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600">Streamline maintenance requests and track work orders from start to finish.</p>
            </CardContent>
          </Card>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Real-time communication system</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
